...
>
> 1. **결과가 매번 다르다** — 일반 기능은 A를 넣으면 B가 나옵니다. AI는 A를 넣으면 B일 수도, B'일 수도 있습니다. 그래서 "되는지 안 되는지"를 **테스트셋(eval)으로 판정**해야 합니다.
...
**4주차 숙제 설명 (15분)** — PRD 양식을 같이 읽고, 예시를 하나 보여줍니다.
...
**[← 이전: 2주차](./02-reverse-planning-1.md)** | **[다음: 4주차 — 문제 정의 + PRD →](./04-prd.md)**
